...
public class train_실습1_2문자열교체_과제 {
	 ...
	 */
    public static String addSubstring(String s1, String s2) {
    	return s1.concat(s2);
    }
    
    public static String replaceString(String newString, String s2, String s3) {
    	return newString.replaceAll(s2, s3);
    }
