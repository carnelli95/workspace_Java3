 ...
 */
    ...
    public static String[] convertValuesToString(boolean boolVal, char charVal, double doubleVal, int intVal, float floatVal) {
    	...
    	answer[0] = String.valueOf(boolVal);
    	answer[1] = String.valueOf(charVal);
    	answer[2] = String.valueOf(doubleVal);
    	answer[3] = String.valueOf(intVal);
    	answer[4] = String.valueOf(floatVal);
    	return answer;
    }
