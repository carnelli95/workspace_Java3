...
class Car implements Vehicle {
	...
	@Override
	public void showVehicle() {
		System.out.println("Car : vehicleOccupants = " + this.vehicleOccupants) ; 
	}
}
...
class Taxi extends Car {
	...
	@Override
	public void showVehicle() {
		System.out.println("Taxi : vehicleOccupants = " + this.vehicleOccupants + ", mileage : " + this.mileage) ; 
	}
}
...
class MotorCycle implements Vehicle{
	...
	@Override
	public void showVehicle() {
		System.out.println("MotorCycle: price : " + this.price);
	}
}
