...
public class Test02_실습대상 {
	...
	public static void main(String[] args) {
		...
		System.out.println("s1,s3의 해시코드 비교>>  " +System.identityHashCode(s1)+":" + System.identityHashCode(s3));//다른 값 - 저장메모리 위치기반 해시코드
		System.out.println("s1, s3의 출력값 비교>>  " + s1 + " : "+ s3.toString());
		System.out.println("s1,s3의 해시코드 비교>>  " +s1.hashCode()+":" + s3.hashCode());//s2, s4 : 같은 값 - 값 기반 해시코드
