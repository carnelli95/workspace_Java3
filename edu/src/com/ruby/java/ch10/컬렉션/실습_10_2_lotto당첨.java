...
public class 실습_10_2_lotto당첨 {
	...
	private static int hitTest(Lotto1 lottoWin, Lotto1 lotto) {
		...
		Set<Integer> win = lottoWin.getLotto();
		Set<Integer> lot = lotto.getLotto();
	...
	public static void main(String[] args) {
		...
		if (!PRINTLOTTO)
			System.out.println(lottoWin.toString());
		...
		for (int i = 1; i <= NUMBEROFLOTTO; i++) {
			if (PRINTLOTTO)
				System.out.print(i + lottoWin.toString() + " : ");
			...
			case 6:
				win[0]++;
				if (PRINTLOTTO)
					System.out.print("축! 1등 당첨~~~~");
				break;
			case 5:
				if (lottoWin.getBonun() == lotto.getBonun()) {
					win[1]++;
					if (PRINTLOTTO)
						System.out.print("축! 2등 당첨~~~~");
				} else {
					win[2]++;
					if (PRINTLOTTO)
						System.out.print("축! 3등 당첨~~~~");
				}
				break;
			case 4:
				win[3]++;
				if (PRINTLOTTO)
					System.out.print("축! 4등 당첨~~~~");
				break;
			case 3:
				win[4]++;
				if (PRINTLOTTO)
					System.out.print("축! 5등 당첨~~~~");
				break;
			default:
				if (PRINTLOTTO)
